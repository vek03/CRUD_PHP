...
class Cadastro extends Banco {
    ...
    public function incluir(){
        return $this->setCadastros($this->getEmail(),$this->getSenha(),$this->getEndereco(),$this->getBairro(),$this->getCep(),$this->getCidade(),$this->getEstado());
    }
    ...
    public function editar(){
        return $this->updateCadastros($this->getId(),$this->getEmail(),$this->getSenha(),$this->getEndereco(),$this->getBairro(),$this->getCep(),$this->getCidade(),$this->getEstado());
    }
}
?>
